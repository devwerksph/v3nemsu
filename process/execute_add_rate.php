...
//$hps_finale=$view_hps_eng + $view_hps_math + $view_hps_sci + $view_hps_abs;
 ...
 $sql = "INSERT INTO `units_rate`(`course_code`,`course_name`,`rate`) VALUES ('$view_course[0]','$view_course[1]','$view_rates')";
    ...
    {?>
              ...
              <div class="popup__content">
                ...
                <p>
                 ...
                 <?php echo "<script>setTimeout(\"location.href = '../dashboard-unit-rates.php';\",2500);</script>"; ?>
                </p>
              </div>
             </div>
               <!--   <script>
