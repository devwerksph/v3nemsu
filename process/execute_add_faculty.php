...
$view_department=$_POST['department'];
$view_major=$_POST['major'];
$view_contact=$_POST['contact'];
$view_fullname=$_POST['lastname'].', '.$_POST['firstname'].' '.$_POST['middlename'].' '.$_POST['suffix'];
...
//$hps_finale=$view_hps_eng + $view_hps_math + $view_hps_sci + $view_hps_abs;
 ...
 $sql = "INSERT INTO `instructor_list`( `INST_NAME`,`INST_COLLEGE`,`INST_DEPARTMENT`,`INST_MAJOR`,`INST_CONTACT`) VALUES ('$view_fullname','$view_college', '$view_department', '$view_major', '$view_contact')";
    ...
    {?>
              ...
              <div class="popup__content">
                ...
                <p>You have created new Faculty Record </p>
                <p>
                 <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
                 <?php echo "<script>setTimeout(\"location.href = '../dashboard-faculty.php';\",2500);</script>"; ?>
                </p>
              </div>
             </div>
               <!--   <script>
...
<?php
             ...
             <div class="popup popup--icon -error js_error-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>
                  <a href="../faculty-load.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
                </p>
              </div>
            </div>
       <!--  <script> 
