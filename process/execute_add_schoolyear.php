...
$view_schoolyear=$_POST['school_year'];
...
//$hps_finale=$view_hps_eng + $view_hps_math + $view_hps_sci + $view_hps_abs;
 ...
 $sql = "INSERT INTO `yrschool_list`(`yrschool_desc`) VALUES ('$view_schoolyear')";
    ...
    {?>
              ...
              <div class="popup__content">
                ...
                <p>
                 ...
                 <?php echo "<script>setTimeout(\"location.href = '../dashboard-other-schoolyear.php';\",2500);</script>"; ?>
                </p>
              </div>
             </div>
               <!--   <script>
...
<?php
             ...
             <div class="popup popup--icon -error js_error-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>
                  <a href="../other-schoolyear.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
                </p>
              </div>
            </div>
       <!--  <script> 
