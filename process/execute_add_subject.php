...
$view_title=$_POST['subject_title'];
$view_code=$_POST['subject_code'];
...
//$hps_finale=$view_hps_eng + $view_hps_math + $view_hps_sci + $view_hps_abs;
 ...
 $sql = "INSERT INTO `subject_list`( `unqctr`,`course_code`,`course_desc`,`subj_code`,`subj_title`,`subj_desc`) VALUES ('$unqctr','$view_course[0]','$view_course[1]','$view_code','$view_title','$view_subject')";
    ...
    {?>
              ...
              <div class="popup__content">
                ...
                <p>You have created new Course Record </p>
                <p>
                 <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
                 <?php echo "<script>setTimeout(\"location.href = '../dashboard-other-subject.php';\",2500);</script>"; ?>
                </p>
              </div>
             </div>
               <!--   <script>
...
<?php
             ...
             <div class="popup popup--icon -error js_error-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>
                  <a href="../other-subject.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
                </p>
              </div>
            </div>
       <!--  <script> 
