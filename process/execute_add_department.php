...
$view_department=$_POST['deaprtment_name'];
...
//$hps_finale=$view_hps_eng + $view_hps_math + $view_hps_sci + $view_hps_abs;
 ...
 $sql = "INSERT INTO `department_list`(`dept_code`,`department_name`) VALUES ('$code','$view_department')";
    ...
    {?>
              ...
              <div class="popup__content">
                ...
                <p>
                 ...
                 <?php echo "<script>setTimeout(\"location.href = '../dashboard-other-department.php';\",2500);</script>"; ?>
                </p>
              </div>
             </div>
               <!--   <script>
...
<?php
             ...
             <div class="popup popup--icon -error js_error-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>
                  <a href="../other-department.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
                </p>
              </div>
            </div>
       <!--  <script> 
