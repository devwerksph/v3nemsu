...
$view_college=explode(",",$_POST['college_desc'] );

$unqctr=generateRandomString(35);
$code=random_strings(6);
$view_course=$_POST['course_desc'];
...
//$hps_finale=$view_hps_eng + $view_hps_math + $view_hps_sci + $view_hps_abs;
 ...
 $sql = "INSERT INTO `course_list`( `unqctr`,`college_code`,`college_desc`,`course_code`,`course_desc`) VALUES ('$unqctr','$view_college[0]','$view_college[1]','$code','$view_course')";
    ...
    {?>
              ...
              <div class="popup__content">
                ...
                <p>
                 ...
                 <?php echo "<script>setTimeout(\"location.href = '../dashboard-other-course.php';\",2500);</script>"; ?>
                </p>
              </div>
             </div>
               <!--   <script>
...
<?php
             ...
             <div class="popup popup--icon -error js_error-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>
                  <a href="../other-course.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
                </p>
              </div>
            </div>
       <!--  <script> 
