...
$view_desc=$_POST['misc_desc'];
$view_fees=$_POST['misc_fees'];
...
//$hps_finale=$view_hps_eng + $view_hps_math + $view_hps_sci + $view_hps_abs;
 ...
 $sql = "INSERT INTO `miscellaneous_rate`(`course_code`,`course_name`,`miscellaneous_name`,`rate`) VALUES ('$view_course[0]','$view_course[1]','$view_desc','$view_fees')";
    ...
    {?>
              ...
              <div class="popup__content">
                ...
                <p>You have created new Miscellaneous Record </p>
                <p>
                 <!--  <a href="index.php"><button class="button button--success" data-for="js_success-popup"></button></a> -->
                 <?php echo "<script>setTimeout(\"location.href = '../dashboard-miscellaneous.php';\",2500);</script>"; ?>
                </p>
              </div>
             </div>
               <!--   <script>
...
<?php
             ...
             <div class="popup popup--icon -error js_error-popup popup--visible">
              ...
              <div class="popup__content">
                ...
                <p>
                  <a href="../other-misc.php"><button class="button button--error" data-for="js_error-popup">Close</button></a>
                </p>
              </div>
            </div>
       <!--  <script> 
