    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header text-center">Create Miscellaneous Fees </h2>
          <div class="container">
    <!-- MultiStep Form -->
          ...
          <div class="row"><!--removed d-flex justify-content-center-->
              <div class="col-md-12">
                  <div class="wizard">
                      ...
                      <form role="form" action="process/execute_add_misc.php" method="post" class="form-style">
                                  ...
                                  <div class="row">
                                    <div class="col-md-5">
                                      ...
                                      <div class="col-md-5">
                                        <div class="form-group">
                                            <label>Miscellaneous </label> 
                                             <input class="form-control" type="text" name="misc_desc" placeholder="Miscellaneous Descriptions">
                                        </div>
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Fees </label> 
                                             <input class="form-control" type="text" name="misc_fees" placeholder="0.00">
                                        </div>
