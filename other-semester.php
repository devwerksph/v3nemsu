          ...
          <div class="row"><!--removed d-flex justify-content-center-->
              <div class="col-md-12">
                  <div class="wizard">
                      ...
                      <form role="form" action="process/execute_add_semester.php" method="post" class="form-style">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Semester of </label> 
                                             <input class="form-control" type="text" name="semester_desc">
                                        </div>
