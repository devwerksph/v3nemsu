    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <br>
          <span>Configure School Year <i class="bi bi-arrow-right"></i> List of School Year</span>  <a class="default-btn pull-right " href="other-schoolyear.php">+ Create New </a>
          ...
          <?php 
            ...
            $sql = "SELECT * FROM `yrschool_list` WHERE status='Enabled' ";
          ...
          <tr>  
            ...
            <td><?php echo $row['yrschool_desc'];?></td> 
            <td><?php echo $row['status'];  ?></td>    
             <td >
             <a href="process/execute_del_sy.php?id=<?php echo $row['ctrlinc'] ;?>" class=" btn-danger "  style="padding:5px "><span class="bi bi-trash-fill"></span></a>
