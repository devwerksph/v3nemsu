    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <br>
          <span>Configure Course <i class="bi bi-arrow-right"></i> List of Course</span>  <a class="default-btn pull-right " href="other-course.php"> + File Record</a>
        ...
        <tbody>  
          ...
          <?php 
            ...
            $sql = "SELECT * FROM `course_list` WHERE `status`='Active' ";
          ...
          <tr>  
            ...
            <td>
              <center><a href="">
                <!-- <span class="bi bi-display-fill"></span></a> -->
              <a href="process/execute_del_course.php?id=<?php echo $row['ctrlinc'] ;?>" class=" btn-danger "  style="padding:5px "><span class="bi bi-trash-fill"></span></a>
              </center>
            </td>  
          </tr>  
