    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header text-center">New College Form</h2>
          <div class="container">
    <!-- MultiStep Form -->
          ...
          <div class="row"><!--removed d-flex justify-content-center-->
              <div class="col-md-12">
                  <div class="wizard">
                      ...
                      <form role="form" action="process/execute_add_college.php" method="post" class="form-style">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            <label>College of </label> 
                                             <input class="form-control" type="text" name="college_desc">
                                        </div>
